...
Load strain, unload strain (both normalized unit), load (in N), and area (in m^2^) were calculated from experimental data and manually entered into r for further processing analysis. We obtained the slope of the stress-strain curve in both conditions, which corresponds to the stiffness of the material in the elastic region.
