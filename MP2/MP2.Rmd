...
ancova_model_2 <- aov(`norm_mean_max_pt_angle` ~ sex + leg_length_m, data = class.gait)
Anova(ancova_model_2, type="III") 

ancova_model_3 <- aov(`norm_mean_max_pt_angle` ~ sex + Mass_Kg, data = class.gait)
Anova(ancova_model_3, type="III") 
```
